...
export default function Header() {
    ...
    return (
        <div className="flex justify-between items-center w-full mt-4 md:mt-8 z-10">
            ...
            <h1 className="text-3xl lg:text-5xl text-center font-extrabold text-white hidden md:block">Build your <a href="/" className={`relative px-2 outlined `}>Perfect Champ</a></h1>
